...
//        Kmp.KMP_old("ababacabacaaba", "abacaaba");
        Kmp.KMP_ad("ababacabacaaba", "abacaaba");
    }

    static void KMP_ad(String parent, String pattern) {
    ...
    static void KMP_old(String parent, String pattern){
         int[] table = makeTable(pattern);
...
//                    System.out.println(i-idx+1 + "번째에서 찾았습니다. ~" + (begin+1) );
                    System.out.println("번째에서 찾았습니다. ~" + (begin+1) );
                }
            }else{
